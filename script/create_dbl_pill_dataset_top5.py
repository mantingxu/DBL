...
# model related
path = "../weight/best_accuracy_pill_0604_1.pth"
...
for error_id in error_ids:
    query_pic_folder = '../pill_dataset/train/{pill_id}/*.png'.format(pill_id=error_id)
    count = 0
...
np.save('/media/wall/4TB_HDD/06/numpy/pillTrain_top5', myRes)
